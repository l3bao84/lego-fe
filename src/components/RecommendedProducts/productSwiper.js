    ...
    useEffect(() => {
        if (swiper && swiper.navigation) {
            const checkNavigation = () => {
                ...
                if (prevEl && nextEl) {
                    prevEl.style.visibility = swiper.isBeginning ? 'hidden' : 'visible';
                    nextEl.style.visibility = swiper.isEnd ? 'hidden' : 'visible';
                }
            };
                            ...
                            <div className={cx('column')}>
                                <div className={cx('detail-row')}>
                                    <div className={cx('image-row')}>
                                        <a
                                            href={`http://localhost:3000/product/${product.productId}`}
                                    ...
                                    <div className={cx('detail-content')}>
                                        <a
                                            href={`http://localhost:3000/product/${product.productId}`}
                                            className={cx('product-leaf-title')}
                                        >
                                            <h3>
