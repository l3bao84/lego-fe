...
import { useDetailProduct, calculateReviewCounts, submitReview } from '../service';
...
function ProductReview() {
    ...
    const hanleSubmitReview = (e, productId) => {
        e.preventDefault();
                                        ...
                                        <form encType="multipart/form-data" method="post">
                                            ...
                                            <div className={cx('review-action-container')}>
                                                <div className={cx('cancel-review-container')}>
                                                    <button onClick={(e) => handleCancelReview(e)} type="button">
                                                        Cancel
                                                    </button>
                                                </div>
                                                <div className={cx('send-review-container')}>
                                                    <input
                                                        onClick={(e) => hanleSubmitReview(e, product.id)}
                                                        type="submit"
